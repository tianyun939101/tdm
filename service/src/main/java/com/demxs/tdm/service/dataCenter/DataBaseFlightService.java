...
public class DataBaseFlightService extends CrudService<DataBaseInfoDao, DataBaseInfo> {
        ...
        if(testCheck != null && "1".equals(dataBaseInfo.getIsFlag())){//试验前检查流程
            ...
            if(null == task){
                ...
                if(null !=auditUser){
                    ...
                    actTaskService.apiStartProcess(GlobalConstans.ActProcDefKey.DATA_TEST_PROCESS,
