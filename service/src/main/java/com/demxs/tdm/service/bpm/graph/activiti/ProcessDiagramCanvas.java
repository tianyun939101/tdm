package com.demxs.tdm.service.bpm.graph.activiti;


import com.demxs.tdm.domain.bpm.constants.ITaskOpinion;
...
//		String text = fitTextToWidth(name, width);
	...
	static {
		try {
			USERTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/user.png"));
			SCRIPTTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/script.png"));
			SERVICETASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/service.png"));
			RECEIVETASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/receive.png"));
			SENDTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/send.png"));
			MANUALTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/manual.png"));
			TIMER_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/timer.png"));
			ERROR_THROW_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/error_throw.png"));
			ERROR_CATCH_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/error_catch.png"));
			CALLACTIVITY_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/demxs/tdm/bpm/graph/image/call_activity.png"));
			...
			colorsMap.put(ITaskOpinion.STATUS_NOT_PASSED, new Color(130, 183,
					215));
	...
	public static Color getColor(String colorString){
		...
		//todo:替换为系统属性设置
		String tempCOLOR = "";
		if("POOL_BACKGROUP_COLOR".equals(colorString)){
			tempCOLOR = "211,215,212";
		}else if("LANE_BOUNDARY_COLOR".equals(colorString)){
			tempCOLOR = "138,140,142";
		}
		Color color=null;
