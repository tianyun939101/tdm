...
//					List<HistoricIdentityLink> il = historyService.getHistoricIdentityLinksForProcessInstance(procInsId);
	...
	public String startProcess(String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
		...
		if (processInstance != null) {
			...
			if (task == null) {
				throw new RuntimeException("您没有权限办理此任务！");
			}
...
//		ProcessInstance procIns = runtimeService.startProcessInstanceByKey(procDefKey, businessTable+":"+businessId, vars);
	...
	public void complete(String taskId, String procInsId, String comment, String title, Map<String, Object> vars){
		...
		if (task == null) {
			throw new IllegalArgumentException("您没有权限办理此任务或任务已被办理完成！");
		}
	 ...
	 * @param comment 审批意见
	 * @param result  1:通过 ,0 : 驳回    Global.YES   Global.NO
	 * @param assignee 下一步审批人
	 */
...
//		return ProcessDiagramGenerator.generateDiagram(bpmnModel, "png", activeActivityIds);
		...
		return new DefaultProcessDiagramGeneratorMine().generateDiagram(bpmnModel, "png", activeActivityIds,highLightedActivitis,highLightedFlows,"宋体","宋体","宋体",null,1.0);
		//return null;
		//return pr.generateDiagram(bpmnModel, "png", activeActivityIds,highLightedActivitis,highLightedFlows,"宋体","宋体","宋体",null,1.0);
	}
	/**
	 * 获取需要高亮的线
