...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.demxs.tdm.common.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.demxs.tdm.common.sys.entity.User(null, userId)))){
