...
public class ExtScriptTaskJsonConverter extends BaseBpmnJsonConverter {
    ...
    public static void fillJsonTypes(Map<String, Class<? extends BaseBpmnJsonConverter>> convertersToBpmnMap) {
        convertersToBpmnMap.put("ScriptTask", ExtScriptTaskJsonConverter.class);
    }

    public static void fillBpmnTypes(Map<Class<? extends BaseElement>, Class<? extends BaseBpmnJsonConverter>> convertersToJsonMap) {
        convertersToJsonMap.put(ServiceTask.class, ExtScriptTaskJsonConverter.class);
    }
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, BaseElement baseElement) {
        ...
        if ("mail".equalsIgnoreCase(serviceTask.getType())) {
            ...
            if (ImplementationType.IMPLEMENTATION_TYPE_CLASS.equals(serviceTask.getImplementationType())) {
                ...
                propertiesNode.put("scripttaskdelegateexpression", serviceTask.getImplementation());
            }
    ...
    protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode, Map<String, JsonNode> shapeMap) {
        ...
        } else if (StringUtils.isNotEmpty(getPropertyValueAsString("scripttaskdelegateexpression", elementNode))) {
            task.setImplementationType(ImplementationType.IMPLEMENTATION_TYPE_DELEGATEEXPRESSION);
            task.setImplementation(getPropertyValueAsString("scripttaskdelegateexpression", elementNode));
        }
