...
public class ExtBpmnJsonConverter implements EditorJsonConstants, StencilConstants, ActivityProcessor, ExtStencilConstants {
    ...
    static {
        ...
        ExtStartEventJsonConverter.fillTypes(convertersToBpmnMap, convertersToJsonMap);
        ...
        SignTaskJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtAndGatewayJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtEndEventJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtMessageTaskJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtOrGatewayJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtScriptTaskJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtStartEventJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtStartSubFlowTaskJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
        ExtXorGatewayJsonConverter.fillTypes(convertersToBpmnMap,convertersToJsonMap);
    }
