 ...
 * @author Joram Barrez
 */
public class DefaultProcessDiagramCanvasMine {

    protected static final Logger LOGGER = LoggerFactory.getLogger(DefaultProcessDiagramCanvasMine.class);
    ...
    protected static Color CURRENT_HIGHLIGHT_COLOR = Color.BLUE;
     ...
     *
     */
    public DefaultProcessDiagramCanvasMine(int width, int height, int minX, int minY, String imageType,
    ...
    public void drawCurrentLight(int x, int y, int width, int height) {
        Paint originalPaint = g.getPaint();
        Stroke originalStroke = g.getStroke();
