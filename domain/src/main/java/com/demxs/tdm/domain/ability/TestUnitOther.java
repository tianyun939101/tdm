 ...
 * @version 2017-10-30
 */
public class TestUnitOther extends DataEntity<TestUnitOther> {
	...
	private String sop;		// SOP文件
	private String otherFiles;		// 不确定度分析文件
	private String collator;		// 整理人
	private String deplete;		// 是否消耗样品
	
	public TestUnitOther() {
		super();
	}

	public TestUnitOther(String id){
		super(id);
	}
	...
	@Length(min=0, max=64, message="SOP文件长度必须介于 0 和 64 之间")
	...
	@Length(min=0, max=2000, message="不确定度分析文件长度必须介于 0 和 2000 之间")
