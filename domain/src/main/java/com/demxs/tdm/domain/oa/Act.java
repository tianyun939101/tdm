...
import com.demxs.tdm.common.utils.TimeUtils;
import com.demxs.tdm.comac.common.act.utils.Variable;
...
//	private Variable taskVars; 	// 流程任务变量
	...
	private String formKey;//表单路径
    /**
     * ntko控件表单路径
     */
    private String ntkoFormKey;
	...
	public String getTaskId() {
		if (taskId == null && task != null){
			taskId = task.getId();
		}else if (taskId == null && histTask != null){
	...
	public String getTaskName() {
		...
		}else if (taskName == null && histTask != null){
...
//	}
    ...
    public String getNtkoFormKey() {
        return ntkoFormKey;
    }

    public Act setNtkoFormKey(String ntkoFormKey) {
        this.ntkoFormKey = ntkoFormKey;
        return this;
    }
}
