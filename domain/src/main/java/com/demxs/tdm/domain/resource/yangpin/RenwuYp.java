 ...
 * @version 2017-06-22
 */
public class RenwuYp extends DataEntity<RenwuYp> {
	...
	private String yangpinzid;		// 样品组id（调度样品主键 zy_diaodu_yp）
	...
	private String renwuzj;		// 任务主键 yw_shiyanrw 表id
	private String renwubh;		// 任务编号
	private String yangpinsysl;     //剩余数量
	private String diaoduzj;     //调度主键 yw_diaodu 表id
	...
	@Length(min=0, max=200, message="是否申请单样品组长度必须介于 0 和 200 之间")
	...
	@Length(min=0, max=200, message="任务主键长度必须介于 0 和 200 之间")
