 ...
 * @version 2017-06-22
 */
public class WeituoYp extends DataEntity<WeituoYp> {
	...
	//=============查询或详情需要=====================//
	private String yangpinlbmc;
	private String leixingmcs;
	private String cunfangwzmc;
	private String weizhimcs;

	private String yewudid;		// 申请单主键（业务数据）
	//=============查询或详情需要=====================//
	public WeituoYp() {
		super();
	}

	public WeituoYp(String id){
		super(id);
	}
	...
	public String getYewudid() {
		return yewudid;
	}

	public void setYewudid(String yewudid) {
		this.yewudid = yewudid;
	}
