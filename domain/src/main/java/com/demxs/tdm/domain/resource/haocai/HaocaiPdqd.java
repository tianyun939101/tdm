 ...
 * @version 2017-08-31
 */
public class HaocaiPdqd extends DataEntity<HaocaiPdqd> {
	...
	private Attachment daorudpdb = new Attachment();	//导入的盘点信息表产生的附件(限定一次盘点上传一张附件)
