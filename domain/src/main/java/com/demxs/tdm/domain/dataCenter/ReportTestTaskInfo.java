 ...
 * 数据中心数据实体类
 */
public class ReportTestTaskInfo extends DataEntity<ReportTestTaskInfo>{

    private static final long serialVersionUID = 1L;

    private String centerName;//单位名称

    private String month1;//1月份

    private String month2;//

    private String month3;//

    private String month4;//1月份

    private String month5;//

    private String month6;//

    private String month7;//1月份

    private String month8;//

    private String month9;//

    private String month10;//1月份
