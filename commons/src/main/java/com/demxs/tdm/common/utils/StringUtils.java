 ...
 　　*/
	...
	public static String replaceSql(String sql){
		...
		for(String key: maps.keySet()){
			sql = sql.replaceAll(key,maps.get(key));
		}
		return sql;
	}
    ...
    public static String getUnHtml(String htmlvalue){
		String temp = StringEscapeUtils.unescapeHtml4(htmlvalue);
		temp = temp.replace("&lt;","<").replace("&gt;",">").replace("&deg;","");
		return temp;
	}
