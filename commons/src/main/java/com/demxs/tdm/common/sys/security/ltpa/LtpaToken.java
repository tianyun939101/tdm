...
/*
    ...
    public static void main(String[] args) {
        LtpaToken token = LtpaToken.generate("admin",new Date(), DateUtils.addMinutes(new Date(),30));
        System.out.println(token);
        LtpaToken ltpaToken = new LtpaToken("AAECAzVBMzM1QzU4NUEzNDA1MTh4aW5nbBgrpmSrh1uax2mmwNYec7Lk2Vp4");
        System.out.println(ltpaToken.getUser());
    }
