...
public class Servlets {
    ...
    public static boolean isStaticFile(String uri){
		if (staticFiles == null){
			try {
				throw new Exception("试验到“app.properties”中没有配置“service.staticFile”属性。配置示例：\n#静态文件后缀\n"
					+"service.staticFile=.css,.js,.png,.jpg,.gif,.jpeg,.bmp,.ico,.swf,.psd,.htc,.crx,.xpi,.exe,.ipa,.apk");
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
