package com.demxs.tdm.common.sys.utils;

import com.demxs.tdm.common.service.BaseService;
import com.demxs.tdm.common.sys.dao.*;
import com.demxs.tdm.common.sys.entity.*;
...
public class UserUtils {
	...
	private static ILabInfoService labInfoService = SpringContextHolder.getBean(ILabInfoService.class);
	public static final String USER_CACHE = "userCache";
	public static final String USER_CACHE_ID_ = "id_";
	public static final String USER_CACHE_LOGIN_NAME_ = "ln";
	public static final String USER_CACHE_NO_ = "num";
	...
	public static User get(String id){
		...
		if (user ==  null){
			user = userDao.get(id);
			//设置试验室
			Map<String,String> map = labInfoService.getLabByUserId(user);
			if(CollectionUtils.isNotEmpty(map)){
				user.setLabInfoId(map.get("id"));
				user.setLabInfoName(map.get("name"));
			}
			if (user == null){
				return null;
			}
	 ...
	 * @return
	 */
	public static User getByEmpNo(String empNo){
		User user = (User)CacheUtils.get(USER_CACHE, USER_CACHE_NO_ + empNo);
		if (user == null){
			User u = new User();
			u.setNo(empNo);
			user = userDao.getByEmpNo(u);
			if (user == null){
				return null;
			}
			user.setRoleList(roleDao.findList(new Role(user)));
	...
	public static List<Menu> getMenuList(){
		...
		if (menuList == null){
			...
			}else if(CollectionUtils.isNotEmpty(user.getRoleList())){
				String strs = "";
				for(Role role : user.getRoleList()){
					strs += role.getDataScope();
				}
				if(strs.indexOf("1")!=-1){
					menuList = menuDao.findAllList(new Menu());
				}else{
