...
public class ZxingHandler {
	 ...
	 * @return
	 */
	public static void createQRCode(String contents, int width, int height, String imgPath) {
		Hashtable<EncodeHintType, Object> hints = new Hashtable<EncodeHintType, Object>();
		// 指定纠错等级
		hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);
		// 指定编码格式
	...
	public static void main(String[] args) {
		...
		//////////////////////////////////////
		//生成二维码图片
		ZxingHandler.createQRCode("S2017072004000101",width,height,"D:\\\\AAAAA.png");
		//////////////////////////////////////
		...
		//解析二维码
		String filepath="D:\\\\910106805145178107.png";
		String decodeContent2 = ZxingHandler.decode2(filepath);
